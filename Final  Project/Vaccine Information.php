<html>
  ...
  <body>
    ...
    <table>
      <tr>
        <td> <img height="200px" width="500px" src="covid-vaccine.jpg"> </td>
        <td><h3><b>Vaccination Information Bangladesh</b></h3></td>
      </tr>
    </table>

              <fieldset>
                <h3 align="center"> <u>Vaccine Information</u> </h3>
                <table>
...
But it’s not vaccines that will stop the pandemic, it’s vaccination. We must ensure fair and equitable access to vaccines, and ensure every country receives them and can roll them out to protect their people, starting with the most vulnerable.</p> </td>
                  ...
                  <tr>
                    <td>
                      <ol>
                        <li> <a href="Pfizer-BioNTech.php">Pfizer-BioNTech</a></li>
                        <li> <a href="Moderna.php">Moderna Vaccine</a> </li>
                        <li> <a href="j&j.php">j&j/janssen vaccine</a> </li>
                      </ol>
                    </td>
                    <br>
                    <br>
                  ...
                  <tr>
                    <th>Total Doses Administration</th>
                    <th>Total Doses Delivered</th>
                    <th>Total Number of People Fully Vaccinated</th>
                  </tr>
                  <tr>
                    <td><img src="a1.JPG"> </td>
                    <td><img src="a2.JPG"> </td>
                    <td><img src="a3.JPG"> </td>
