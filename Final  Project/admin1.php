...
<table>
    ...
    <tr>
        <td>
            <img src="admin logo.jpg" width=<?php echo $imageWidth?> height=<?php echo $imageHeight?> />
        </td>
        <td><h2>  <span style="background-color:<?php echo $backColor?>; color:<?php echo $fontColor?>">
                THANK YOU </h2></span>
        </td>
    </tr>
